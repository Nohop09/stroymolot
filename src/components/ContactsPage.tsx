...
export function ContactsPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email",
      content: "stroymolot37@mail.ru",
      link: "mailto:stroymolot37@mail.ru",
    },
    {
      icon: MapPin,
      title: "Адрес",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Позвоните нам или оставьте заявку, и наш специалист свяжется с
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="mailto:stroymolot37@mail.ru">
                <Button
                  size="lg"
                  variant="outline"
