...
export function AboutPage() {
  const values = [
    ...
    },
    {
      icon: Building,
      title: "Опыт",
      description: "Более 200 успешно реализованных проектов",
    },
    {
      icon: Users,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  СтройМолот был основан в 2013 году группой опытных инженеров и строителей, 
                  объединённых общей целью — создавать качественные и надёжные строительные объекты.
                </p>
                <p className="text-gray-600 mb-4">
                  За более чем 10 лет работы мы выросли из небольшой бригады в крупную строительную 
                  компанию с собственным парком техники, командой из 150+ специалистов и портфолио 
                  из более чем 200 успешно реализованных проектов.
                </p>
