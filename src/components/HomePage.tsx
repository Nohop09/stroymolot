      ...
      <section className="relative h-[600px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-20 text-center">
          <h1 className="text-5xl md:text-6xl mb-6">
            СтройМолот — надёжное строительство под ключ
          </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8">
              СтройМолот — это команда профессионалов с более чем 10-летним опытом в строительной индустрии. 
              Мы специализируемся на полном цикле строительных работ: от монтажа металлоконструкций до отделки 
              интерьеров. Наша миссия — создавать надёжные объекты, которые служат десятилетиями.
            </p>
            <Button
              onClick={() => onNavigate("about")}
            ...
            <div className="bg-white rounded-lg shadow-md p-8 mb-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-900">info@stroymolot.ru</p>
                </div>
                <div className="text-center">
