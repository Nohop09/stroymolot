  ...
  const projects = [
    {
      ...
      description:
        "Монтаж кровли в жилом доме — надёжный финальный штрих строительства.",
    ...
    },
    {
      ...
      category: "finishing",
      description:
        "Выполнен демонтаж здания с соблюдением всех норм и требований",
...

    {
      ...
      category: "construction",
      description: "Выполнен монтаж кровли в частном доме коттеджного типа",
    ...
    },
    {
      ...
      category: "renovation",
      description:
        "Выполнено залитие межэтажного перекрытия в частном коттедже в Крюково",
    ...
    },
    {
      ...
      category: "finishing",
      description:
        "Бывшие заводы ДСК — выполнен демонтаж зданий промышленных предприятий",
    ...
    {
      id: 6,
      title: "Ивановский  энергоуниверситет",
      category: "finishing",
      description:
        "В рамках реконструкции здания выполнен демонтаж внутренних конструкций",
